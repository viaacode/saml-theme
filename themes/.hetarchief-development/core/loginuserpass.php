    ...
    <div class="o-container o-container--small">
	  ...
	  <div class="o-flex o-flex--vertical" style="margin: 0 auto;">
	   ...
	   <p class="o-flex__item u-spacer-s u-text-center">
		 ...
		 <div class="c-button__label"><a href="http://account-tst.hetarchief.be/users/password/new?redirect_to=<?php echo urlencode($sid['url']); ?>">Naar wachtwoord instellen</a></div>
                 </div>
               </button>
           </p>
        </div>
        ...
        <div class="u-spacer-bottom-l">
          ...
          <div class="c-content">
            <p class="u-text-muted">
              <a href="http://account-tst.hetarchief.be/users/password/new?redirect_to=<?php echo urlencode($sid['url']); ?>">Wachtwoord vergeten?</a>
            </p>
          </div>
        </div>
      </form>
