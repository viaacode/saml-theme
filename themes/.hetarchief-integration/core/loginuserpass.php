	        ...
	        <div class="o-flex o-flex--vertical" style="margin: 0 auto;">
              ...
              <button class="c-button c-button--link">
                <div class="c-button__content">
                    ...
                    <a href="https://ssum-int-iam.private.cloud.meemoo.be/users/password/new?redirect_to=<?php echo urlencode($sid['url']); ?>">Een nieuw wachtwoord instellen</a>
                  </div>
                </div>
              </button>
            </p>
            ...
            <div class="o-flex o-form-group o-flex--justify-between">
              ...
              <div class="c-content">
                <button class="c-button c-button--link">
                  <div class="c-button__content">
                    <div class="c-button__label">
                      <a href="https://ssum-int-iam.private.cloud.meemoo.be/users/password/new?redirect_to=<?php echo urlencode($sid['url']); ?>">Logingegevens vergeten?</a>
                    </div>
                  </div>
                </button>
              </div>
