    ...
    <div class="o-container o-container--small">
	  ...
	  <div class="o-flex o-flex--vertical" style="margin: 0 auto;">
	   ...
	   <p class="o-flex__item u-spacer-s u-text-center">
		 ...
		 <div class="c-button__label"><a href="https://account-qas.hetarchief.be/users/password/new?redirect_to=<?php echo urlencode($sid['url']); ?>">Een nieuw wachtwoord instellen</a></div>
                 </div>
               </button>
           </p>
        </div>
